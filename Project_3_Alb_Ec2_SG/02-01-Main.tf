...
module "Application_Load_Balancer_Security_Group" {
  source                     = "./5-Security_Groups"
  vpc_id                     = module.vpc.vpc_id
...
module "Alb" {
  source             = "./Alb"
  aws_lb_vpc_id      = module.vpc.vpc_id
  load_balancer_Name = var.load_balancer_Name
  alb_security_group = [module.Application_Load_Balancer_Security_Group.Security_Group_id]
  alb_subnets = [module.vpc.Public_Subnets[0],
  module.vpc.Public_Subnets[1]]
  aws_lb_Tags = merge(var.vpc_tags, {
    "Name" = "Application_Load_Balancer"
  })
  aws_lb_target_Instance_1_id = module.Ec2_Instance_Private[0].Instance_Id
  aws_lb_target_Instance_2_id = module.Ec2_Instance_Private[1].Instance_Id
}